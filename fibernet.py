...
features = list(Fiber_df.drop(['active_cust'],axis=1).columns) #this code gives a list of column names except 'active_cust'
...
# Perform Grid Search
clf = GridSearchCV(clf_tree, tuned_parameters, cv=10, scoring='roc_auc', n_jobs=-1)
clf.fit(X_train, y_train)

# Get the best parameters
best_score = clf.best_score_
best_params = clf.best_params_
cv_results = clf.cv_results_  # Correct replacement for grid_scores_
